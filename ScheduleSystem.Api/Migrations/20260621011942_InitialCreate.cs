        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Employees_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Captains_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Captains_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Captains_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAvailableDays", x => new { x.EmployeeId, x.DayOfWeek });
                    table.ForeignKey(
                        name: "FK_EmployeeAvailableDays_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAvailableShifts", x => new { x.EmployeeId, x.ShiftId });
                    table.ForeignKey(
                        name: "FK_EmployeeAvailableShifts_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeAvailableShifts_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vacations_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DaysOffEntries", x => new { x.DaysOffId, x.DayOfWeek });
                    table.ForeignKey(
                        name: "FK_DaysOffEntries_DaysOff_DaysOffId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Captains_EmployeeId",
                table: "Captains",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Captains_OwnerId",
                table: "Captains",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Captains_PlanId",
                table: "Captains",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAvailableShifts_ShiftId",
                table: "EmployeeAvailableShifts",
                column: "ShiftId");
